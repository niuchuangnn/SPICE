...
pre_model = "./results/imagenet10/moco/checkpoint_4999.pth.tar"
embedding = "./results/imagenet10/embedding/feas_moco_512_l2.npy"
resume = "./results/imagenet10/{}/checkpoint_last.pth.tar".format(model_name)
model_type = "resnet34"
num_head = 10
num_workers = 4
device_id = 0
